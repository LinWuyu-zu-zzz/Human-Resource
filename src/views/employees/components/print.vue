<template>
  <div class="app-container">
    <!-- 打印功能: v-print='myPrint' 其中myPrint指选择器,即id名 -->
...
<script>
import { getPersonalDetail as getPersonalDetail, getEmployeesJobInfo as getJobDetail } from '@/api/employees'
import { getUserDetailById as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
      userId: this.$route.params.id,
      type: this.$route.query.type // 打印类型,query参数?号
    }
  },
  // 创建完毕状态
  created() {
